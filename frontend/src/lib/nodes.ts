...
const OllamaIcon = createIconComponent(
	'https://static.horst.ai/ollama-logo.png',
...
export const nodeTypes = (Object.keys(nodes) as (keyof typeof nodes)[]).reduce<Record<string, any>>(
	(acc, key: keyof typeof nodes) => {
