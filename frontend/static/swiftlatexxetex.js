...
function compileLaTeXRoutine() {
	...
	if (status === 0) {
		...
		try {
			...
			status = -253;
			self.postMessage({ result: 'failed', status: status, log: self.memlog, cmd: 'compile' });
			return;
		}
		self.postMessage(
			{
...
var wasmBinaryFile;
wasmBinaryFile = 'swiftlatexxetex.wasm';
...
var _compileLaTeX = (Module['_compileLaTeX'] = function () {
	return (_compileLaTeX = Module['_compileLaTeX'] = Module['asm']['R']).apply(null, arguments);
});
var _compileFormat = (Module['_compileFormat'] = function () {
	return (_compileFormat = Module['_compileFormat'] = Module['asm']['S']).apply(null, arguments);
});
var _compileBibtex = (Module['_compileBibtex'] = function () {
	return (_compileBibtex = Module['_compileBibtex'] = Module['asm']['T']).apply(null, arguments);
});
var _setMainEntry = (Module['_setMainEntry'] = function () {
	return (_setMainEntry = Module['_setMainEntry'] = Module['asm']['U']).apply(null, arguments);
});
var _main = (Module['_main'] = function () {
	return (_main = Module['_main'] = Module['asm']['V']).apply(null, arguments);
});
var ___errno_location = (Module['___errno_location'] = function () {
	return (___errno_location = Module['___errno_location'] = Module['asm']['X']).apply(
		null,
		arguments
	);
});
var _memalign = (Module['_memalign'] = function () {
	return (_memalign = Module['_memalign'] = Module['asm']['Y']).apply(null, arguments);
});
var _setThrew = (Module['_setThrew'] = function () {
	return (_setThrew = Module['_setThrew'] = Module['asm']['Z']).apply(null, arguments);
});
