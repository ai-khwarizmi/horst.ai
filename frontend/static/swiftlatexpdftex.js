...
var _compileLaTeX = (Module['_compileLaTeX'] = function () {
	return (_compileLaTeX = Module['_compileLaTeX'] = Module['asm']['Q']).apply(null, arguments);
});
var _compileFormat = (Module['_compileFormat'] = function () {
	return (_compileFormat = Module['_compileFormat'] = Module['asm']['R']).apply(null, arguments);
});
var _compileBibtex = (Module['_compileBibtex'] = function () {
	return (_compileBibtex = Module['_compileBibtex'] = Module['asm']['S']).apply(null, arguments);
});
var _setMainEntry = (Module['_setMainEntry'] = function () {
	return (_setMainEntry = Module['_setMainEntry'] = Module['asm']['T']).apply(null, arguments);
});
var _main = (Module['_main'] = function () {
	return (_main = Module['_main'] = Module['asm']['U']).apply(null, arguments);
});
var ___errno_location = (Module['___errno_location'] = function () {
	return (___errno_location = Module['___errno_location'] = Module['asm']['W']).apply(
		null,
		arguments
	);
});
var _setThrew = (Module['_setThrew'] = function () {
	return (_setThrew = Module['_setThrew'] = Module['asm']['X']).apply(null, arguments);
});
